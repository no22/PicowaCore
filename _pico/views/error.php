...
<table border="1" cellspacing="0" cellpadding="0" style="margin: auto;">
	<tr>
		<th colspan="2" style="padding: 5px; background-color:#5F9EF8;">Error Information</th>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="padding: 5px; background-color:#FFFFFF;"><pre style="width: 400px; overflow-x: auto;"><?php debug_print_backtrace(); ?></pre></td>
	</tr>
</table>
</body>
</html>
